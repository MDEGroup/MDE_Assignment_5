...
/**
 * This is the item provider adapter for a {@link WebApplication.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider extends ContentItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebApplicationPackage.Literals.FORM__METHOD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebApplicationPackage.Literals.FORM__ELEMENTS);
			childrenFeatures.add(WebApplicationPackage.Literals.FORM__ENTITY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebApplicationPackage.Literals.FORM__ELEMENTS,
				 WebApplicationFactory.eINSTANCE.createElements()));

		newChildDescriptors.add
			(createChildParameter
				(WebApplicationPackage.Literals.FORM__ENTITY,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == WebApplicationPackage.Literals.FORM__ENTITY;
