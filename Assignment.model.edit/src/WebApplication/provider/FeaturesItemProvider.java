...
/**
 * This is the item provider adapter for a {@link WebApplication.Features} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeaturesItemProvider extends EntityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebApplicationPackage.Literals.FEATURES__REFERENCE);
			childrenFeatures.add(WebApplicationPackage.Literals.FEATURES__ATTRIBUTES_F);
		}
	...
	public String getText(Object object) {
		String label = ((Features)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Features_type") :
			getString("_UI_Features_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebApplicationPackage.Literals.FEATURES__REFERENCE,
				 WebApplicationFactory.eINSTANCE.createReferences()));

		newChildDescriptors.add
			(createChildParameter
				(WebApplicationPackage.Literals.FEATURES__ATTRIBUTES_F,
