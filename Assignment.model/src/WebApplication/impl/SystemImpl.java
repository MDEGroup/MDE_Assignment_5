 ...
 * </p>
 * <ul>
 *   <li>{@link WebApplication.impl.SystemImpl#getData <em>Data</em>}</li>
 *   <li>{@link WebApplication.impl.SystemImpl#getContent <em>Content</em>}</li>
 *   <li>{@link WebApplication.impl.SystemImpl#getPage <em>Page</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemImpl extends MinimalEObjectImpl.Container implements WebApplication.System {
	/**
	...
	protected EClass eStaticClass() {
		return WebApplicationPackage.Literals.SYSTEM;
	}
	...
	public EList<Data> getData() {
		if (data == null) {
			data = new EObjectContainmentEList<Data>(Data.class, this, WebApplicationPackage.SYSTEM__DATA);
		}
		return data;
	}
	...
	public EList<Content> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<Content>(Content.class, this, WebApplicationPackage.SYSTEM__CONTENT);
		}
		return content;
	}
	...
	public EList<Page> getPage() {
		if (page == null) {
			page = new EObjectContainmentEList<Page>(Page.class, this, WebApplicationPackage.SYSTEM__PAGE);
		}
		return page;
	}
